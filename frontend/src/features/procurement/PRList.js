...
import { Plus, Download, Search, Eye, Edit, RotateCcw, FileText, Filter } from 'lucide-react';
...
const PRList = ({ onNavigate }) => {
    ...
    },
    {
      ...
      render: (row) => (
        <div className="max-w-[200px]">
          ...
          <p className="text-[10px] text-neutral-400 truncate">{row.purpose}</p>
        </div>
      )
    },
    {
  ...
  const mockData = [
    { id: 1, prNo: 'PR-2024-0012', date: '05/12/2024', summary: 'Office Supplies Q4', purpose: 'For administrative use', budgetSource: 'MOOE - Supplies', amount: 45200.00, status: 'Draft' },
    { id: 2, prNo: 'PR-2024-0011', date: '05/11/2024', summary: 'IT Equipment', purpose: 'Replacement of old units', budgetSource: 'MOOE - IT Equipment', amount: 125000.00, status: 'For Review' },
    { id: 3, prNo: 'PR-2024-0010', date: '05/10/2024', summary: 'Janitorial Supplies', purpose: 'Monthly replenishment', budgetSource: 'MOOE - Supplies', amount: 15300.00, status: 'Approved' },
    { id: 4, prNo: 'PR-2024-0009', date: '05/08/2024', summary: 'Fuel & Oil', purpose: 'Fleet consumption', budgetSource: 'MOOE - Fuel', amount: 85000.00, status: 'Rejected' },
    { id: 5, prNo: 'PR-2024-0008', date: '05/05/2024', summary: 'Security Services', purpose: 'Quarterly payment', budgetSource: 'MOOE - Services', amount: 320000.00, status: 'Obligated' },
  ];

  return (
    <div className="space-y-3">
      <PageHeader
        path="Transactions / Procurement Requests"
        ...
        actions={
          <div className="flex gap-2">
            ...
            <Button variant="primary" icon={Plus} size="sm" onClick={() => onNavigate('create-pr')}>Create PR</Button>
          </div>
        }
      />
